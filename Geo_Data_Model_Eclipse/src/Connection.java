...
public class Connection {
    ...
    public List<Marker> getData() throws JSONException {
        ...
        try {
            url = new URL("https://api.myjson.com/bins/1kixm");
    ...
    public List<Marker> generateJSON(JSONArray json){
        ...
        try {
            ...
            for (int i = 0; i < json.length(); i++) {
                ...
                found.add(new Marker(obj.getJSONObject("geometry").getJSONArray("coordinates").getDouble(0),obj.getJSONObject("geometry").getJSONArray("coordinates").getDouble(1)));
            }
